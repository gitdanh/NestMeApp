        ...
        <View style={container.formCenter}>
          ...
          >
            <View style={{flexDirection: 'row'}}>
              <IconMaterialCommunityIcons color={"white"} size={30} name="keyboard-backspace" style={{marginRight: 10}} onPress={()=> props.navigation.goBack()}/>
            ...
            >
              ...
              />
              <Text style={{fontSize: 16, fontWeight: '500', color: "#0095f6"}} onPress={() => setIsModalVisible(true)}>Change your avatar</Text>
            </View>
            <Text style={{fontSize: 16, fontWeight: '500', color: "white", padding: 10}}>Full name</Text>
            <TextInput
              style={form.textInput}
              value={fullname}
              onChangeText={(val) => setFullname(val)}
            />
            <Text style={{fontSize: 16, fontWeight: '500', color: "white", padding: 10}}>Bio</Text>
            <TextInput
                ...
                <View style={{flex: 1, backgroundColor: "black", borderTopColor: "#262626", borderTopWidth: 5}}>
                    <View style={{ paddingLeft: 20, paddingRight: 20, display: "flex", flexDirection:"row", alignItems:"center", justifyContent: "space-between", backgroundColor: "#262626", paddingTop: 10, paddingBottom: 15}}>
                        <View style={{display: "flex", flexDirection:"row", alignItems:"center"}}>
                            <AntDesign color={"white"} size={27} name="close" onPress={() => props.navigation.goBack()}/>
                        </View>
                        {showGallery && <Text style={{fontSize: 16, fontWeight: '500', color: "#0095f6"}} onPress={handleGoToSaveOnGalleryPick}>Next</Text>}
