...
const SingleChat = (props) => {
    ...
    return (
        <View style={styles.container}>
            <View style={{flexDirection: 'row', paddingHorizontal: 10, paddingBottom: 5, justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <View style={{marginLeft: 10}}>
                        ...
                        <Text style={{fontSize: 12,color: '#888888'}}>
                            {isOnline ? ("Active Now") : ("Active " + calculatedTime(lastOnl) + " ago")}
                        </Text>
                    </View>
                </View>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
